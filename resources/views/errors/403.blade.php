...
<head>
    ...
    <title>403 - Acceso Denegado - AccordionZone</title>
...
<body class="bg-gray-50 font-sans antialiased">
    <div class="min-h-screen flex flex-col items-center justify-center px-4">
        ...
        <div class="max-w-lg w-full bg-white rounded-lg shadow-lg p-8 text-center">
            <div class="text-6xl font-bold text-red-700 mb-4">403</div>
            <h1 class="text-2xl font-bold text-gray-800 mb-4">
                <i class="fas fa-lock text-red-700"></i> Acceso Denegado
            </h1>
            <p class="text-gray-600 mb-6">No tienes permiso para acceder a este recurso. Si crees que es un error, contacta con nuestro soporte.</p>
