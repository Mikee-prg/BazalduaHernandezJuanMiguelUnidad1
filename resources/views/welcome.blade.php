        ...
        <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                @foreach ([
                    ...
                    ['icon' => 'fa-screwdriver-wrench', 'title' => 'Refacciones', 'text' => 'Piezas para reparación, ajuste y restauración con compatibilidad revisada.', 'items' => ['Fuelles', 'Cañas', 'Botones y válvulas']],
        ...
        <section id="buzon" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
            <div class="bg-white rounded shadow-sm border border-red-100 p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <a href="{{ route('sitemap') }}" class="border border-red-100 rounded p-4 hover:bg-red-50"><i class="fas fa-sitemap text-red-700 mr-2"></i> Mapa del sitio</a>
